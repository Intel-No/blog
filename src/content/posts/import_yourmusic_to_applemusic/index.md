...
![](photos/import_yourmusic_to_applemusic_1.png)

## 3.拖入待转换音频文件

![](photos/import_yourmusic_to_applemusic_2.png)

拖入文件后，会如下图所示

![](photos/import_yourmusic_to_applemusic_3.png)

## 4.双击待转换的音频文件

![](photos/import_yourmusic_to_applemusic_4.png)

可以看到完成了格式转换，点击右侧的放大镜，就可打开文件位置

## 5.打开iTuns

![](photos/import_yourmusic_to_applemusic_5.png)

点击“最近添加”，将文件拖入

即可看到有一个新的“未知专辑”

![](photos/import_yourmusic_to_applemusic_6.png)

之后的歌曲信息等内容自己按需填写就行（歌词导入也是同理，只不过没有滚动效果）

打开手机上的Apple Music也可以看到，成功同步

![](photos/import_yourmusic_to_applemusic_7.png)
